...
function ConversationView() {
  ...
  // Calculate rotation for the trust meter arrow (0-100 range)
  // 0 trust = -90deg, 100 trust = +90deg.
  const trustArrowRotation = (trustLevel / 100) * 180 - 90;
      ...
      <div className="npc-area"> {/* Main flex row container for left and right sections */}
        ...
        <div className="npc-indicators-right">
          ...
          <div className="trust-meter-section">
            <div className="trust-dial-container">
              <img 
                src="/icons/dial.svg" 
                alt="Trust Dial" 
                className="trust-dial-svg" 
              />
              <img
                src="/icons/dial-pointer.svg"
                alt="Trust Arrow"
                className="trust-arrow-svg"
                style={{ 
                  transform: `rotate(${trustArrowRotation}deg)`
                }}
              />
            </div>
